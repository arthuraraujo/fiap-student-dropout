...
try:
    ...
    print(f"AVISO CRÍTICO: Falha ao importar 'config' (src.src.config). Detalhes: {e}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print(f"Exemplo: python -m src.src.preprocess_utils data/raw")
        sys.exit(1)
