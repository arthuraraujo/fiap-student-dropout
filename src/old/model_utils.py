...
# Isso é importante para 'from src.src.config import ...' funcionar
# quando o script é executado como 'python -m src.src.model_utils ...'
...
# Se 'src' é a raiz do seu projeto e 'src' está dentro dele.

try:
    from src.src.config import MODEL_PATH, PREPROCESSOR_PATH, TRAINING_COLUMNS_PATH
    # As funções de preprocess_utils são necessárias para o predict_pipeline
    from src.src.preprocess_utils import engineer_features, preprocess_data_split_save 
except ModuleNotFoundError:
    print("AVISO CRÍTICO: Falha ao importar 'config' ou 'preprocess_utils' de 'src.src'.")
