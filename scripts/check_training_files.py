...
def main():
    ...
    required_files = [
        ("src/data/processed/train_data.joblib", "Training data"),
        ("src/data/processed/val_data.joblib", "Validation data"),
    ]
    
    # Arquivos opcionais mas importantes
    optional_files = [
        ("src/models/preprocessor_objects.joblib", "Preprocessor"),
        ("src/models/training_columns.joblib", "Training columns"),
        ("src/models/random_forest_model.joblib", "Trained model"),
    ]
    ...
    directories_to_check = [
        ("src/data/raw", "Raw data directory"),
        ("src/data/processed", "Processed data directory"),
